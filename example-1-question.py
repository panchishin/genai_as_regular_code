...
We will create a new LLM handler with the directive "Answer questions with one word."
Then we can ask it questions easily, like a simple function call.

""")

# set up the handler
one_word_general_answers = LLM(directive="Answer questions with one word.")
